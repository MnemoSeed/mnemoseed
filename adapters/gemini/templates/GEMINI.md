...
A MnemoSeed daemon captures this session through Gemini hooks into a persistent,
...
- **Per-turn injection.** Relevant memory is attached to every agent turn. Use it
  as context, and call `memory.recall` for deliberate, deeper searches.
