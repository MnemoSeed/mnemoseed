...
would be a cycle (``mnemoseed.dream`` imports ``mnemoseed.llm.types`` via
...
from mnemoseed.llm.types import ChatResult, HealthReport, LLMDriverInfo
...
class StubLLM:
    ...
    def __init__(self, model: str = "stub", **kwargs: Any) -> None:
        ...
        # through monkeypatch on mnemoseed.dream.reflect).
        from mnemoseed.dream.reflect import StubReflectLLM
