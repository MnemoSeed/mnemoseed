...
| D4 | **Keep dual repos** (core Python / mcp Node), no switch to a monorepo | The integration layer is replaceable by nature; independent CI and version cadence; restructuring at zero-code stage has only cost and no benefit |
